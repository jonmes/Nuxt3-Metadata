...
const cardSlider = [
  {
    ...
    partner: [
      "/images/MLs_Logo_color.png",
      "/images/ILO_color.png",
      "/images/MOFA_color.png",
      "/images/mc_color.png",
    ],
    client: ["/images/MLs_Logo_color.png"],
    id: "1",
  },
  {
    thumbnail:
      "/images/projects/World-Bank-C.png",
    // Two
  ...
  {
    thumbnail:
      "/images/projects/Jobs-Protection-C.png",
    // Four
