...
<template>
  ...
  >
    ...
    >
      ...
      <li class="flex justify-center">
        <NuxtLink
          :to="{ path: '/HahuUniversity', hash: '#services' }"
          class="text-lg font-medium leading-[35px] duration-500 hover:text-primary"
          :class="
            $route.fullPath == '/HahuUniversity#services'
              ? 'text-primary'
              : 'text-HahuGray1 dark:text-white'
          "
          @click="open = !open"
      ...
      <li class="flex justify-center">
        <NuxtLink
          :to="{ path: '/HahuUniversity', hash: '#about' }"
          class="text-lg font-medium leading-[35px] duration-500 hover:text-primary"
          :class="
            $route.fullPath == '/HahuUniversity#about'
              ? 'text-primary'
              : 'text-HahuGray1 dark:text-white'
          "
          @click="open = !open"
