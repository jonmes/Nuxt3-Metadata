  ...
  >
    <div class="z-10 flex items-center">
      <span class="mr-1 text-xl text-white">
        ...
        <h1 class="mt-2 text-base font-light leading-4 text-[#444F60] dark:text-white">Muya</h1>
      </span>
    </div>
    <MenuAlt3Icon
      @click="open = !open"
      class="w-8 z-20 cursor-pointer items-center dark:text-white lg:hidden"
    />
    ...
    >
      ...
      <li class="flex justify-center">
        <NuxtLink
          :to="{ path: '/HahuMuya', hash: '#partners' }"
          class="text-lg font-medium leading-[35px] duration-500 hover:text-primary"
          :class="
            $route.fullPath == '/HahuMuya#partners'
              ? 'text-primary'
              : 'text-HahuGray1 dark:text-white'
          "
          @click="open = !open"
      ...
      <li class="flex justify-center">
        <NuxtLink
          :to="{ path: '/HahuMuya', hash: '#about' }"
          class="text-lg font-medium leading-[35px] duration-500 hover:text-primary"
          :class="
            $route.fullPath == '/HahuMuya#about'
              ? 'text-primary'
              : 'text-HahuGray1 dark:text-white'
          "
          @click="open = !open"
      ...
      <li class="flex justify-center">
        <button
          class="rounded-md bg-primary px-[25px] py-2 text-base font-medium leading-6 text-white"
        >
          Login
        </button>
      </li>
