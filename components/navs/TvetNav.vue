  ...
  >
    <div class="z-10 flex items-center">
      <span class="mr-1 text-xl text-white">
        ...
        <h1 class="mt-2 text-base font-light leading-4 text-[#444F60]">TVET</h1>
      </span>
    </div>
    <MenuAlt3Icon
      @click="open = !open"
    ...
    >
      ...
      <li class="flex justify-center">
        <NuxtLink
          :to="{ path: '/HahuTvet', hash: '#services' }"
          class="text-lg font-medium leading-[35px] duration-500 hover:text-primary"
          :class="
            $route.fullPath == '/HahuTvet#services'
              ? 'text-primary'
              : 'text-HahuGray1 dark:text-white'
          "
          @click="open = !open"
      ...
      <li class="flex justify-center">
        <NuxtLink
          :to="{ path: '/HahuTvet', hash: '#about' }"
          class="text-lg font-medium leading-[35px] duration-500 hover:text-primary"
          :class="
            $route.fullPath == '/HahuTvet#about'
              ? 'text-primary'
              : 'text-HahuGray1 dark:text-white'
          "
          @click="open = !open"
