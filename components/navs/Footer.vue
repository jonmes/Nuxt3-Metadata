<template>
  ...
  >
    <div class="flex flex-col">
      ...
      <img
        ...
        class="mt-[13px] object-contain dark:hidden"
      />
      <img
        src="/images/Hahu_footer_logo1_dark.png"
        class="mt-[13px] hidden object-contain dark:block"
      />

      <img
        src="/images/Hahu_footer_logo2.png"
        class="mt-[9px] mb-[41px] object-contain dark:hidden"
      />
      <img
        src="/images/Hahu_footer_logo2_dark.png"
        class="mt-[9px] mb-[41px] hidden object-contain dark:block"
      />
    </div>
    <div
      class="flex flex-col space-y-10 lg:flex-row lg:space-x-16 lg:space-y-0 xl:space-x-[85px]"
    >
      <NuxtLink
        :to="{ name: 'index' }"
        class="transform-gpu text-xl font-medium leading-[30px] text-gray-500 duration-200 hover:rotate-12 hover:text-black dark:text-HahuGray/4"
        >Services</NuxtLink
      >
      <NuxtLink
        :to="{ name: 'index' }"
  ...
  <div
    class="flex h-[93px] flex-col items-center justify-center space-y-10 bg-white px-8 duration-500 ease-in dark:bg-DarkModeBg md:px-[50px] lg:mb-0 lg:flex-row lg:justify-between lg:space-y-0 xl:px-[100px]"
  >
    <h1 class="text-base font-medium leading-6 text-gray-400">
      © 2022 HaHu Jobs. All rights reserved.
    </h1>
