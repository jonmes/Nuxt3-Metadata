<template>
  <div class="min-h-screen overflow-y-auto px-8 md:px-[50px] xl:px-[100px]">
    ...
    <section class="flex flex-col" id="partners">
      ...
      <h2
        class="mt-7 self-center text-3xl font-semibold leading-[35px] text-HahuGray1 dark:text-HahuGray/4"
      >
        Our Partners
      </h2>
      <p
    ...
    <section class="flex flex-col" id="about">
      ...
      <div
        class="mt-[59px] grid grid-cols-1 justify-items-center gap-[38px] lg:grid-cols-3"
      >
        <div
